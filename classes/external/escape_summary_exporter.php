...
/**
 * Class for exporting partial escape data.
 *
 * @package    mod_escape
 * @copyright  2017 Juan Leyva <juan@moodle.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
namespace mod_escape\external;
...
/**
 * Class for exporting partial escape data (some fields are only viewable by admins).
 *
 * @copyright  2017 Juan Leyva <juan@moodle.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class escape_summary_exporter extends exporter {
    ...
    protected static function define_properties() {
        ...
        return array(
            ...
            'course' => array(
                'type' => PARAM_INT,
                'description' => 'Foreign key reference to the course this escape is part of.'
            ),
            'coursemodule' => array(
                'type' => PARAM_INT,
            ...
            'intro' => array(
                'type' => PARAM_RAW,
                'description' => 'Escape introduction text.',
                'optional' => true,
            ),
            'introformat' => array(
            ...
            'usepassword' => array(
                'type' => PARAM_BOOL,
                'description' => 'Password protected escape?',
                'optional' => true,
            ),
            'password' => array(
                'type' => PARAM_RAW,
            ...
            'dependency' => array(
                'type' => PARAM_INT,
                'description' => 'Dependent on (another escape id)',
                'optional' => true,
            ),
            'conditions' => array(
                'type' => PARAM_RAW,
                'description' => 'Conditions to enable the escape',
                'optional' => true,
            ),
            'grade' => array(
                'type' => PARAM_INT,
            ...
            'activitylink' => array(
                'type' => PARAM_INT,
                'description' => 'Id of the next activity to be linked once the escape is completed',
                'optional' => true,
            ),
            'mediafile' => array(
                'type' => PARAM_RAW,
            ...
            'slideshow' => array(
                'type' => PARAM_BOOL,
                'description' => 'Display escape as slideshow',
                'optional' => true,
            ),
            'width' => array(
                'type' => PARAM_INT,
            ...
            'allowofflineattempts' => array(
                'type' => PARAM_BOOL,
                'description' => 'Whether to allow the escape to be attempted offline in the mobile app',
            ),
        );
    }
    ...
    protected function get_other_values(renderer_base $output) {
        ...
        if (isset($this->data->intro)) {
            $values['introfiles'] = external_util::get_area_files($context->id, 'mod_escape', 'intro', false, false);
            $values['mediafiles'] = external_util::get_area_files($context->id, 'mod_escape', 'mediafile', 0);
        }
