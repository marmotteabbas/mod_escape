...
/**
 * The mod_escape page_moved event class.
 *
 * @package    mod_escape
 ...
 *     - int prevpageid: the id of the previous escape page
 *     - int nextpageid: the id of the next escape page
 * }
 *
 * @package    mod_escape
 * @since      Moodle 2.9
...
class page_moved extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventpagemoved', 'mod_escape');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' has moved a ".$this->other['pagetype']." page with the ".
                ...
                "' in the escape activity with course module id '$this->contextinstanceid'.";
    }
    ...
    public static function get_other_mapping() {
        $othermapped = array();
        $othermapped['prevpageid'] = array('db' => 'escape_pages', 'restore' => 'escape_page');
        $othermapped['nextpageid'] = array('db' => 'escape_pages', 'restore' => 'escape_page');
