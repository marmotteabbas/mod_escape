...
//////////////////////////////////////////////////////////*/
    ...
    function show_clock() {
        ...
        var mytime = '',
            myclock = document.getElementById("escape-timer");
        if (current > starttime + testlength) {
            mytime += M.util.get_string('timeisup', 'escape');
            stopclock = 1;
        } else {
