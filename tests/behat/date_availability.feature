@mod @mod_escape
Feature: A teacher can set available from and deadline dates to access a escape
  In order to schedule escape activities
  As a teacher
  ...
  Scenario: Forbidding escape accesses until a specified date
    Given I add a "Escape" to section "1"
