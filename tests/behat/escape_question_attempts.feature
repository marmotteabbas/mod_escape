@mod @mod_escape
Feature: In a escape activity, students can not re-attempt a question more than the allowed amount
  In order to check a escape question can not be attempted more than the allowed amount
