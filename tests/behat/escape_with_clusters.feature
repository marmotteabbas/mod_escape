@mod @mod_escape
Feature: In a escape activity, students can see questions in random order
  In order to create a escape with clusters
  As a teacher
  ...
  Scenario: Escape with two clusters
    ...
    When I follow "Escape with clusters"
