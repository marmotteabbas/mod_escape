@mod @mod_escape
Feature: In a escape activity, teacher can edit a cluster page
  In order to modify an existing escape and change navigation
  As a teacher
  I need to edit cluster pages in the escape
  ...
  Scenario: Edit escape cluster page
