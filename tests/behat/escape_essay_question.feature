@mod @mod_escape @_file_upload
Feature: In a escape activity, teacher can add an essay question
  As a teacher
  I need to add an essay question in a escape and grade student attempts
  ...
  Scenario: questions with essay question
    ...
    And I should see "Student 1"
    And I click on ".escape-attempt-link" "css_element" in the "Student 1" "table_row"
