...
Feature: Escape group override
  ...
  Background:
    ...
    And the following "activities" exist:
      ...
      | escape   | Test escape name | Test escape description | 1          | C1     | escape1  |
  ...
  Scenario: Allow a single group to have re-take the escape
    When I follow "Test escape name"
  ...
  Scenario: Add both a user and group override and verify that both are applied correctly
    ...
    And I am on "Course 1" course homepage
    And I follow "Test escape"
    And I should see "This escape will be open on Friday, 1 January 2021, 8:00"
    And I log out
    And I log in as "student2"
    And I am on "Course 1" course homepage
    And I follow "Test escape"
    And I should see "This escape will be open on Tuesday, 1 January 2030, 8:00"
    And I log out
    And I log in as "student3"
    And I am on "Course 1" course homepage
    And I follow "Test escape"
    And I should see "This escape will be open on Wednesday, 1 January 2020, 8:00"
