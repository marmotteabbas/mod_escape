@mod @mod_escape
Feature: In a escape activity, students can review the answers they gave to questions
  To review questions of a escape
  As a student
  I need to complete a escape answering all of the questions.
