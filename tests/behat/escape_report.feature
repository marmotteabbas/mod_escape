@mod @mod_escape
Feature: In a escape activity, teachers can review student attempts
  To review student attempts in a escape
  As a Teacher
  ...
  Scenario: View student attempts in a escape containing both content and question pages
