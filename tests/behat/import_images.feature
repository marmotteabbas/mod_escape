@mod @mod_escape
Feature: In a escape activity, teacher can import embedded images in questions answers and responses
  As a teacher
  I need to import a question with images in answers and responses in a escape

  @javascript @_file_upload
  Scenario: Import questions with images in answers and responses in a escape
    ...
    And I upload "mod/escape/tests/fixtures/multichoice.xml" file to "Upload" filemanager
    And I press "Import"
