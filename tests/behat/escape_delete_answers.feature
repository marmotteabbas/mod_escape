@mod @mod_escape
Feature: In a escape activity, teacher can delete question answers and
branch table contents
  In order to modify an existing escape
  As a teacher
  I need to question answers and branch table contents in the escape
  ...
  Scenario: Edit escape content page
  ...
  Scenario: Edit escape question page
