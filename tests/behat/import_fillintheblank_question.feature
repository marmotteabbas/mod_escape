@mod @mod_escape
Feature: In a escape activity, teacher can import blackboard fill in the blank question
  As a teacher
  I need to import a fill in the blank question made in Blackboard in a escape

  @javascript @_file_upload
  Scenario: Import fill in the blank question in a escape
    ...
    And I upload "mod/escape/tests/fixtures/sample_blackboard_fib_qti.dat" file to "Upload" filemanager
    And I press "Import"
