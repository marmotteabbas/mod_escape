@mod @mod_escape
Feature: In a escape activity, students can see their progress viewing a progress bar.
  In order to create a escape with conditional paths
  As a teacher
  ...
  Scenario: Student navigation with progress bar
    ...
    And I should see "You have completed 0% of the escape"
    And I press "Next page"
    And I should see "Second page contents"
    And I should see "You have completed 33% of the escape"
    And I press "Previous page"
    And I should see "First page contents"
    And I should see "You have completed 67% of the escape"
    And I press "Next page"
    And I should see "Second page contents"
    And I should see "You have completed 67% of the escape"
    And I press "Next page"
    ...
    And I should see "You have completed 100% of the escape"
