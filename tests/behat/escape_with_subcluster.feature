@mod @mod_escape
Feature: In a escape activity, students can see questions in random order and a single question drawn from a branch
  In order to create a escape with a cluster and a subcluster
  As a teacher
  ...
  Scenario: Escape with subcluster
    Given I add a "Escape" to section "1" and I fill the form with:
      | Name | Escape with subcluster |
      | Description | Test escape description |
    And I follow "Escape with subcluster"
    ...
    When I follow "Escape with subcluster"
