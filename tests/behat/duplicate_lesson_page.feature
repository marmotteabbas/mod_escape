@mod @mod_escape
Feature: In a escape activity, a teacher can duplicate a escape page
  In order to duplicate a escape page
  As a teacher
  I need to add content to a escape
  ...
  Background:
    ...
    And I upload "mod/escape/tests/fixtures/moodle_logo.jpg" file to "Files" filemanager
