@mod @mod_escape
Feature: In a escape activity, students can exit and re-enter the activity when it consists only of cluster pages
  As a student
  I need to exit and re-enter a escape out and into clusters.
  ...
  Background:
    ...
    And I add a "Escape" to section "1" and I fill the form with:
      | Name | Escape with cluster |
      | Description | Cluster escape description |
    And I follow "Escape with cluster"
  ...
  Scenario: Accessing as student to a cluster only escape
