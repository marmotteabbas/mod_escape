@mod @mod_escape
Feature: In a escape activity, if custom scoring is not enabled, student should see
  some informations at the end of escape: questions answered, correct answers, grade, score

  Scenario: Informations at end of escape if custom scoring not enabled
