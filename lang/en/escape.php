...
/**
 * Strings for component 'escape', language 'en', branch 'MOODLE_20_STABLE'
 *
 * @package mod_escape
...
$string['activitylink_help'] = 'To provide a link at the end of the escape to another activity in the course, select the activity from the drop-down menu.';
$string['activitylinkname'] = 'Go to {$a}';
$string['activityoverview'] = 'You have escapes that are due';

$string['addaclickingpicture'] = "Add A Clicking Picture";
$string['clickingpicture'] = 'Clicking Picture';
...
$string['additionalattemptsremaining'] = 'Completed, You can re-attempt this escape';
...
$string['allowofflineattempts'] = 'Allow escape to be attempted offline using the mobile app';
$string['allowofflineattempts_help'] = 'If enabled, a mobile app user can download the escape and attempt it offline.
All the possible answers and correct responses will be downloaded as well.
Note: It is not possible for a escape to be attempted offline if it has a time limit.';
$string['and'] = 'AND';
...
$string['cannotfindnextpage'] = 'Escape backup: Next page not found!';
$string['cannotfindpagerecord'] = 'Add end of branch: page record not found';
$string['cannotfindpages'] = 'Could not find escape pages';
...
$string['cannotfindrecords'] = 'Error: could not find escape records';
$string['cannotfindtimer'] = 'Error: could not find escape_timer records';
...
$string['closebeforeopen'] = 'Could not update the escape. You have specified a close date before the open date.';
...
$string['completederror'] = 'Complete the escape';
$string['completethefollowingconditions'] = 'You must complete the following condition(s) in <b>{$a}</b> escape before you can proceed.';
$string['completionendreached'] = 'Require end reached';
$string['completionendreached_desc'] = 'Student must reach the end of escape page to complete this activity';
...
$string['configintro'] = 'The values set here define the default values that are used in the settings form when creating a new escape activity. Settings specified as advanced are only shown when the \'Show more...\' link is clicked.';
...
$string['configpassword_desc'] = 'Whether a password is required in order to access the escape.';
...
$string['configtimelimit_desc'] = 'If a time limit is set, a warning is displayed at the beginning of the escape and there is a countdown timer. If set to zero, then there is no time limit.';
$string['confirmdelete'] = 'Delete page';
$string['confirmdeletionofthispage'] = 'Confirm deletion of this page';
$string['congratulations'] = 'Congratulations - end of escape reached';
...
$string['deleteallattempts'] = 'Delete all escape attempts';
$string['deletedefaults'] = 'Deleted {$a} x escape default';
...
$string['dependencyon_help'] = 'This setting allows access to this escape to be dependent upon a student\'s performance in another escape in the same course. Any combination of time spent, completed or "grade better than" may be used.';
...
$string['displayleftif_help'] = 'This setting determines whether a student must obtain a certain grade before viewing the escape menu. This forces the student to go through the entire escape on their first attempt, then after obtaining the required grade they can use the menu for review.';
...
$string['displayreview_help'] = 'If enabled, when a question is answered incorrectly, the student is given the option to try it again for no point credit, or continue with the escape.';
...
$string['editescapesettings'] = 'Edit escape settings';
...
$string['endofescape'] = 'End of escape';
...
$string['eolstudentoutoftime'] = 'Attention:  You ran out of time for this escape.  Your last answer may not have counted if it was answered after the time was up.';
$string['eolstudentoutoftimenoanswers'] = 'You did not answer any questions.  You have received a 0 for this escape.';
$string['essay'] = 'Essay';
$string['essayemailmessage2'] = '<p>Essay prompt: {$a->question}</p><p>Your response: <em>{$a->response}</em></p><p>Grader\'s comments: <em>{$a->comment}</em></p><p>You have received {$a->earned} out of {$a->outof} for this essay question.</p><p>Your grade for the {$a->escape} escape has been changed to {$a->newgrade}&#37;.</p>';
$string['essayemailsubject'] = 'Grade available for escape question';
...
$string['eventescapeended'] = 'Escape ended';
$string['eventescaperestarted'] = 'Escape restarted';
$string['eventescaperesumed'] = 'Escape resumed';
$string['eventescapestarted'] = 'Escape started';
$string['eventoverridecreated'] = 'Escape override created';
$string['eventoverridedeleted'] = 'Escape override deleted';
$string['eventoverrideupdated'] = 'Escape override updated';
...
$string['gotoendofescape'] = 'Go to the end of the escape';
$string['grade'] = 'Grade';
...
$string['handlingofretakes_help'] = 'If re-takes are allowed, this setting specifies whether the grade for the escape is the mean or maximum of all attempts.';
...
$string['inactiveoverridehelp'] = '* Student does not have the correct group or role to view/attempt the escape';
$string['insertedpage'] = 'Inserted page';
$string['indicator:cognitivedepth'] = 'Escape cognitive';
$string['indicator:cognitivedepth_help'] = 'This indicator is based on the cognitive depth reached by the student in a Escape activity.';
$string['indicator:socialbreadth'] = 'Escape social';
$string['indicator:socialbreadth_help'] = 'This indicator is based on the social breadth reached by the student in a Escape activity.';
$string['invalidfile'] = 'Invalid file';
$string['invalidid'] = 'No course module ID or escape ID were passed';
$string['invalidescapeid'] = 'escape ID was incorrect';
$string['invalidoverrideid'] = 'Invalid override id';
$string['invalidpageid'] = 'Invalid page ID';
$string['jump'] = 'Jump';
$string['jumps'] = 'Jumps';
$string['jumps_help'] = 'Each answer (for questions) or description (for content pages) has a corresponding jump. The jump can be relative, such as this page or next page, or absolute, specifying any one of the pages in the escape.';
$string['jumpsto'] = 'Jumps to <em>{$a}</em>';
$string['leftduringtimedsession'] = 'You have left during a timed escape.';
$string['leftduringtimed'] = 'You have left during a timed escape.<br />Please click on Continue to restart the escape.';
$string['leftduringtimednoretake'] = 'You have left during a timed escape and you are<br />not allowed to retake or continue the escape.';
$string['escape:addinstance'] = 'Add a new escape';
$string['escape:grade'] = 'Grade escape essay questions';
$string['escapeclosed'] = 'This escape closed on {$a}.';
$string['escapecloses'] = 'Escape closes';
$string['escapeeventcloses'] = '{$a} closes';
$string['escapecloseson'] = 'Escape closes on {$a}';
$string['escape:edit'] = 'Edit a escape activity';
$string['escapeformating'] = 'Escape formatting';
$string['escape:manage'] = 'Manage a escape activity';
$string['escape:manageoverrides'] = 'Manage escape overrides';
$string['escape:view'] = 'View escape activity';
$string['escape:viewreports'] = 'View escape reports';
$string['escapename'] = 'Escape: {$a}';
$string['escapemenu'] = 'Escape menu';
$string['escapenotready'] = 'This escape is not ready to be taken.  Please contact your {$a}.';
$string['escapenotready2'] = 'This escape is not ready to be taken.';
$string['escapeopen'] = 'This escape will be open on {$a}.';
$string['escapeopens'] = 'Escape opens';
$string['escapeeventopens'] = '{$a} opens';
$string['escapepagelinkingbroken'] = 'First page not found.  Escape page linking must be broken.  Please contact an admin.';
$string['escapestats'] = 'Escape statistics';
...
$string['maxgrade_help'] = 'This setting specifies the maximum grade for the escape. If set to 0, the escape does not appear in the grades pages.';
$string['maximumnumberofanswersbranches'] = 'Maximum number of answers';
$string['maximumnumberofanswersbranches_help'] = 'This setting specifies the maximum number of answers that may be used in the escape. If only true/false questions are used, it can be set to 2. The setting may be changed at any time, since it only affects what the teacher sees, not the data.';
$string['maximumnumberofattempts'] = 'Maximum number of attempts';
$string['maximumnumberofattempts_help'] = 'This setting specifies the maximum number of attempts allowed for each question. If answered incorrectly repeatedly, when the maximum is reached, the next page of the escape is displayed.';
...
$string['mediafile_help'] = 'A media file may be uploaded for use in the escape. A \'Click here to view\' link will then be displayed in a block called \'Linked media\' on each page of the escape.';
$string['mediafilepopup'] = 'Click here to view';
$string['mediaheight'] = 'Popup window height';
$string['mediawidth'] = 'Popup window width';
$string['messageprovider:graded_essay'] = 'Escape essay graded notification';
...
$string['modattempts_help'] = 'If enabled, students can navigate through the escape again from the start.';
$string['modattemptsnoteacher'] = 'Student review only works for students.';
$string['modulename'] = 'Escape';
$string['modulename_help'] = 'The escape activity module enables a teacher to deliver content and/or practice activities in  interesting and flexible ways. A teacher can use the escape to create a linear set of content pages or instructional activities that offer a variety of paths or options for the learner. In either case, teachers can choose to increase engagement and ensure understanding by including a variety of questions, such as multiple choice, matching and short answer. Depending on the student\'s choice of answer and how the teacher develops the escape, students may progress to the next page, be taken back to a previous page or redirected down a different path entirely.

A escape may be graded, with the grade recorded in the gradebook.
...
$string['modulename_link'] = 'mod/escape/view';
$string['modulenameplural'] = 'Escapes';
...
$string['noessayquestionsfound'] = 'No essay questions found in this escape.';
$string['nohighscores'] = 'No high scores';
$string['noescapeattempts'] = 'No attempts have been made on this escape.';
$string['noescapeattemptsgroup'] = 'No attempts have been made by {$a} group members on this escape.';
$string['none'] = 'None';
...
$string['nooverridedata'] = 'You must override at least one of the escape settings.';
$string['noretake'] = 'You are not allowed to retake this escape.';
$string['normal'] = 'Normal - follow escape path';
$string['notcompleted'] = 'Not completed';
$string['notyetcompleted'] = 'Escape has been started, but not yet completed';
$string['notdefined'] = 'Not defined';
$string['notenoughsubquestions'] = 'Not enough sub-questions have been defined!';
$string['notenoughtimespent'] = 'You completed this escape in {$a->timespent}, which is less than the required time of {$a->timerequired}. You might need to attempt the escape again.';
...
$string['numberofpagestoshow_help'] = 'This setting specifies the number of pages shown in a escape. It is only applicable for escapes with pages shown in a random order (when "Action after correct answer" is set to "Show an unseen page" or "Show an unanswered page"). If set to zero, then all pages are shown.';
...
$string['overridegroupeventname'] = '{$a->escape} - {$a->group}';
$string['overrides'] = 'Overrides';
$string['overrideuser'] = 'Override user';
$string['overrideusereventname'] = '{$a->escape} - Override';
$string['overview'] = 'Overview';
$string['overview_help'] = 'A escape is made up of a number of pages and optionally content pages. A page contains some content and usually ends with a question. Associated with each answer to the question is a jump. The jump can be relative, such as this page or next page, or absolute, specifying any one of the pages in the escape. A content page is a page containing a set of links to other pages in the escape, for example a Table of Contents.';
$string['page'] = 'Page: {$a}';
$string['page-mod-escape-x'] = 'Any escape page';
$string['page-mod-escape-view'] = 'View or preview escape page';
$string['page-mod-escape-edit'] = 'Edit escape page';
...
$string['passwordprotectedescape'] = '{$a} is a password protected escape.';
...
$string['pluginadministration'] = 'Escape administration';
$string['pluginname'] = 'Escape';
...
$string['practice'] = 'Practice escape';
$string['practice_help'] = 'A practice escape does not appear in the gradebook.';
$string['preprocesserror'] = 'Error occurred during pre-processing!';
$string['prerequisiteisobsolete'] = 'The prerequisite escape option is due to be removed. Please use access restrictions instead.';
$string['prerequisiteescape'] = 'Prerequisite escape';
$string['preview'] = 'Preview';
$string['previewescape'] = 'Preview {$a}';
...
$string['privacy:metadata:grades'] = 'A record of the grades for each escape';
...
$string['privacy:metadata:timer:escapetime'] = 'The last moment when we recorded activity';
...
$string['privacy:metadata:timer'] = 'A record of a escape attempt';
...
$string['privacy:metadata:overrides:available'] = 'The time when the escape may be attempted';
$string['privacy:metadata:overrides:deadline'] = 'The deadline for completing the escape.';
$string['privacy:metadata:overrides:timelimit'] = 'Time limit to complete the escape, in seconds.';
...
$string['privacy:metadata:overrides:password'] = 'The password to access the escape';
$string['privacy:metadata:overrides'] = 'A record of overrides per escape';
$string['privacy:metadata:userpref:escapeview'] = 'The preferred display mode when editing escapes';
...
$string['progressbar_help'] = 'If enabled, a bar is displayed at the bottom of escape pages showing approximate percentage of completion.';
$string['progresscompleted'] = 'You have completed {$a}% of the escape';
$string['progressbarteacherwarning'] = 'Progress bar does not display for {$a}';
$string['progressbarteacherwarning2'] = 'You will not see the progress bar because you can edit this escape';
...
$string['retakesallowed_help'] = 'If enabled, students can attempt the escape more than once.';
$string['returnto'] = 'Return to {$a}';
$string['returntocourse'] = 'Return to the course';
$string['reverttodefaults'] = 'Revert to escape defaults';
$string['review'] = 'Review';
$string['reviewescape'] = 'Review escape';
...
$string['savechangesandeol'] = 'Save all changes and go to the end of the escape.';
...
$string['search:activity'] = 'Escape - activity information';
...
$string['slideshow_help'] = 'If enabled, the escape is displayed as a slideshow, with a fixed width and height.';
...
$string['startescape'] = 'Start escape';
$string['studentattemptescape'] = '{$a->lastname}, {$a->firstname}\'s attempt number {$a->attempt}';
$string['studentname'] = '{$a} Name';
$string['studentoneminwarning'] = 'Warning: You have 1 minute or less to finish the escape.';
$string['studentoutoftimeforreview'] = 'Attention: You ran out of time for reviewing this escape';
$string['studentresponse'] = '{$a}\'s response';
$string['submit'] = 'Submit';
$string['submitname'] = 'Submit name';
$string['teacherjumpwarning'] = 'An {$a->cluster} jump or an {$a->unseen} jump is being used in this escape.  The next page jump will be used instead.  Login as a student to test these jumps.';
...
$string['timelimit_help'] = 'If enabled, a warning about the time limit is displayed at the beginning of the escape and a countdown timer is displayed. Any answers given after the time has elapsed are not graded.';
$string['timelimitwarning'] = 'You have {$a} to finish the escape.';
$string['timeremaining'] = 'Time remaining';
$string['timespenterror'] = 'Spend at least {$a} minutes in the escape';
...
$string['usepassword'] = 'Password protected escape';
$string['usepassword_help'] = 'If enabled, a password is required in order to access the escape.';
$string['useroverrides'] = 'User overrides';
$string['useroverridesdeleted'] = 'User overrides deleted';
$string['usersnone'] = 'No students have access to this escape';
...
$string['youhaveseen'] = 'You have seen more than one page of this escape already.<br />Do you want to start at the last page you saw?';
...
$string['editclickingpicture'] = 'Editing a clicking picture';
